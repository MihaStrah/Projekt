...
struct RKMonth: View {
                            ...
                            HStack() {
                                ...
                                if self.isThisMonth(date: column) {
                                    RKCell(rkDate: RKDate(
                                        ...
                                        isCancelled: self.isOneOfCancelledDates(date: column),
                                        isOntime: self.isOneOfOntimeDates(date: column),
                                        isDelayed: self.isOneOfDelayedDates(date: column)),
    ...
    func isOneOfCancelledDates(date: Date) -> Bool {
        return self.rkManager.CancelledDatesContains(date: date)
    }

    func isOneOfOntimeDates(date: Date) -> Bool {
        return self.rkManager.OnTimeDatesContains(date: date)
    }

    func isOneOfDelayedDates(date: Date) -> Bool {
        return self.rkManager.DelayedDatesContains(date: date)
    }
