...
struct RKCell_Previews : PreviewProvider {
    static var previews: some View {
        Group {
            ...
            RKCell(rkDate: RKDate(date: Date(), rkManager: RKManager(calendar: Calendar.current, minimumDate: Date(), maximumDate: Date().addingTimeInterval(60*60*24*365), mode: 0, cancelledDates: [], onTimeDates: [], delayedDates: []), isDisabled: false, isToday: true, isSelected: false, isBetweenStartAndEnd: false, isCancelled: false, isOntime: false, isDelayed: false), cellWidth: CGFloat(32))
                .previewDisplayName("Control")
//            RKCell(rkDate: RKDate(date: Date(), rkManager: RKManager(calendar: Calendar.current, minimumDate: Date(), maximumDate: Date().addingTimeInterval(60*60*24*365), mode: 0), isDisabled: false, isToday: false, isSelected: false, isBetweenStartAndEnd: false, isCancelled: false, isOntime: false, isDelayed: true), cellWidth: CGFloat(32))
